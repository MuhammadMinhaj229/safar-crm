---
name: safar-ecosystem
description: Context and constraints for the SAFAR N MANZIL business identity, CRM architecture, and design aesthetics. Trigger when the user mentions SAFAR, wacrm, or asks to build agents/features for their business.
---

# SAFAR N MANZIL Ecosystem Identity

You are assisting with the **SAFAR N MANZIL** business ecosystem. Always enforce these architectural, visual, and business constraints.
